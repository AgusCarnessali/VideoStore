...
public class Main {
    public static void main(String[] args) {
        ...
        videoStore.addClient(cliente1);
        videoStore.addClient(cliente2);
        videoStore.addClient(cliente3);
        videoStore.addMovie(peli1);
        videoStore.addMovie(peli2);
        videoStore.addMovie(peli3);
        videoStore.addMovie(peli4);
        videoStore.addMovie(peli5);
        videoStore.addMovie(peli6);
        videoStore.addMovie(peli7);
        videoStore.addMovie(peli8);
        videoStore.addMovie(peli9);
        videoStore.addMovie(peli10);
        videoStore.addMovie(peli11);
        videoStore.addMovie(peli12);
        //endregion
        ...
        do {
            ...
            switch (option) {
                ...
                case 5:
                    ...
                    break;
                case 0:
                    Consola.escribir("Volviendo al menu general");
                    break;
            }
        } while (option != 0);
        menuGral(video);
